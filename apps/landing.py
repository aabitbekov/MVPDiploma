...
def buildMain():
    ...
    with st.container():
        ...
        with right_col:
            ...
            st.write(
                "****Руководитель НТП:  ӘЛІПБЕКИ Оңғарбек Әліпбекұлы,  доктор биологических наук, профессор биологии,  Академик Международной академии информатизации и Казахстанской национальной академии естественных наук Республики Казахстан****")
            st.write(
                "Разработано специалистами «Astana IT University» в рамках реализации программно-целевого финансирования НТП BR10764919 МСХ РК «Исследование влияния государственной политики в отрасли сельского хозяйства на развитие кооперационных процессов в АПК, устойчивого развития сельских территорий и обеспечения продовольственной безопасности» на 2021-2023 годы")
